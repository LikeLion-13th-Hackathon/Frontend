...
const USEFULNESS = ["Practicality", "Durability", "Versatiltiy", "Convienience", "Value of money"];
const MAX_REVIEW_LEN = 3000;

export default function ReviewGoods() {
    ...
    <Layout>
      ...
      <Page>
        ...
        <Card>
          ...
          <FieldLabel style={{ marginTop: 14 }}>Usefulness</FieldLabel>
          <ChipRow>
            {USEFULNESS.map((t, i) => (
              <MultiChoiceChip
                key={t}
